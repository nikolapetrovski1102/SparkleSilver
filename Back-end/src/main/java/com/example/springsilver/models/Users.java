...
public class Users {
    ...
    public Users(String username, Integer userRoles, String password, String email, List<Orders> orders, String last_name, String first_name, String image_pathurl, boolean isActive) {
